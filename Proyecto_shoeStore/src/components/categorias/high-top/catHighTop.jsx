...
import "./catHighTop.css"
import DetallesHighTop from "./detalles-highTop";
import { RxCross1 } from "react-icons/rx";

function GrillaHighTop() {
...
return (
  ...
  <div className="botonYfrase">
    <h1 className="frase">Zapatillas High-Top</h1>
  ...
  {selectProduct && (
    <div className="detalle-producto" onClick={handleProductClick}>
      ...
      <div className="detalle-contenido" onClick={(e) => e.stopPropagation()}>
        ...
        <DetallesHighTop productoExterno= {selectProduct} />
      </div>    
  </div>
  )}
</>
